import"./button-CKICkMOT.js";import{_ as Z,d as q}from"./tree_select-TBFvi8sH.js";import"./radio_group-CyS_Gqqs.js";import{r as d,b as c,o as m,j as v,c as a,y as n,f as p,x as f,u as ee,F as te}from"./vue.esm-bundler-CPPrNTGp.js";import{A as x}from"./index-wXGUTIPA.js";import"./utils-zdN4c4KV.js";import"./_commonjsHelpers-Cpj98o6Y.js";const oe={class:"w-60"},G=Object.assign({name:"disabled"},{__name:"disabled",setup(u){const t=d("");return(r,s)=>{const e=c("k-input");return m(),v("div",oe,[a(e,{modelValue:t.value,"onUpdate:modelValue":s[0]||(s[0]=o=>t.value=o),placeholder:"Disabled Input",disabled:""},null,8,["modelValue"])])}}});G.__docgenInfo={name:"disabled",exportName:"default",displayName:"disabled",description:"",tags:{},sourceFiles:["/home/runner/work/storybook8/storybook8/src/doc/input/disabled.vue"]};const se=`<template>
  <div class="w-60">
...
<\/script>
<style scoped></style>
`,ne={class:"w-60"},H={__name:"clearable",setup(u){const t=d("");return(r,s)=>{const e=c("k-input");return m(),v("div",ne,[a(e,{modelValue:t.value,"onUpdate:modelValue":s[0]||(s[0]=o=>t.value=o),placeholder:"请输入",clearable:""},null,8,["modelValue"])])}}};H.__docgenInfo={exportName:"default",displayName:"clearable",description:"",tags:{},sourceFiles:["/home/runner/work/storybook8/storybook8/src/doc/input/clearable.vue"]};const ae=`
<template>
  <div class="w-60">
...
`,Ne={title:"Data Entry(DE)/KInput",component:q,tags:["autodocs"],argTypes:{type:{control:"text",description:"原生input类型"},clearable:{control:"boolean",description:"是否可清空"},showPassword:{control:"boolean",description:"是否显示密码"},maxlength:{control:"number",description:"最大输入长度"},showWordLimit:{control:"boolean",description:"显示输入字数限制"},autosize:{control:"object",description:"文本域自适应高度, 接收对象例如 { minRows: 2, maxRows: 6 }"},blur:{description:"el, 使 input 失去 焦点"},focus:{description:"el, 使 input 获取 焦点"},select:{description:"el, 选中 input 中的文字"},resizeTextarea:{description:"el, 改变 textarea 大小"}},args:{}},_={name:"默认用法",args:{type:"text",clearable:!1},render:u=>{const t=d("");return{components:{KInput:q},setup(){return{args:u,text:t}},template:`
      ...
      `}}},w=x(G,"disabled : 禁止输入",se),b=x(H,"clearable : 一键清空",ae),k=x(J,"showPassword : 显示密码",ie),g=x(M,"textarea : 文本域",me),h=x(Q,"maxInput : 最大输入长度",_e),y=x(X,"组合使用&前后插槽",Se);setTimeout(()=>{},1);var V,I,S;_.parameters={..._.parameters,docs:{...(V=_.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: '默认用法',
  args: {
    type: 'text',
    clearable: false
...
}`,...(S=(I=_.parameters)==null?void 0:I.docs)==null?void 0:S.source}}};var K,P,B;w.parameters={...w.parameters,docs:{...(K=w.parameters)==null?void 0:K.docs,source:{originalSource:"ATExample(disabled, 'disabled : 禁止输入', disabledDoc)",...(B=(P=w.parameters)==null?void 0:P.docs)==null?void 0:B.source}}};var A,D,$;b.parameters={...b.parameters,docs:{...(A=b.parameters)==null?void 0:A.docs,source:{originalSource:"ATExample(clearable, 'clearable : 一键清空', clearableDoc)",...($=(D=b.parameters)==null?void 0:D.docs)==null?void 0:$.source}}};var E,N,R;k.parameters={...k.parameters,docs:{...(E=k.parameters)==null?void 0:E.docs,source:{originalSource:"ATExample(showPassword, 'showPassword : 显示密码', showPasswordDoc)",...(R=(N=k.parameters)==null?void 0:N.docs)==null?void 0:R.source}}};var U,T,C;g.parameters={...g.parameters,docs:{...(U=g.parameters)==null?void 0:U.docs,source:{originalSource:"ATExample(ktextarea, 'textarea : 文本域', textareaDoc)",...(C=(T=g.parameters)==null?void 0:T.docs)==null?void 0:C.source}}};var O,F,L;h.parameters={...h.parameters,docs:{...(O=h.parameters)==null?void 0:O.docs,source:{originalSource:"ATExample(maxInput, 'maxInput : 最大输入长度', maxInputDoc)",...(L=(F=h.parameters)==null?void 0:F.docs)==null?void 0:L.source}}};var W,z,j;y.parameters={...y.parameters,docs:{...(W=y.parameters)==null?void 0:W.docs,source:{originalSource:"ATExample(frontAndRearSlots, '组合使用&前后插槽', frontAndRearSlotsDoc)",...(j=(z=y.parameters)==null?void 0:z.docs)==null?void 0:j.source}}};const Re=["def","disabledSB","clearableSB","showPasswordSB","textareaSB","maxInputSB","frontAndRearSlotsSB"];export{Re as __namedExportsOrder,b as clearableSB,_ as def,Ne as default,w as disabledSB,y as frontAndRearSlotsSB,h as maxInputSB,k as showPasswordSB,g as textareaSB};
