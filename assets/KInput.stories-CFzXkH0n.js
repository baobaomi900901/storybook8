...
}`,...(W=(L=m.parameters)==null?void 0:L.docs)==null?void 0:W.source}}};var R,_,P;l.parameters={...l.parameters,docs:{...(R=l.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: "尺寸",
  render: (args: any) => {
    const text = ref("");
    const text1 = ref("");
...
}`,...(P=(_=l.parameters)==null?void 0:_.docs)==null?void 0:P.source}}};var H,M,N;c.parameters={...c.parameters,docs:{...(H=c.parameters)==null?void 0:H.docs,source:{originalSource:`{
  name: "输入长度限制",
  render: (args: any) => {
    const text = ref("");
    const text1 = ref("");
