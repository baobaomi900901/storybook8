...
$vxe-ui-status-danger-tinge-color: $vxe-ui-status-error-tinge-color;
...
$vxe-ui-status-danger-lighten-color: $vxe-ui-status-error-lighten-color;
...
$vxe-ui-status-danger-darken-color: $vxe-ui-status-error-darken-color;
...
$vxe-ui-status-danger-disabled-color: $vxe-ui-status-error-disabled-color;
...
/*menu*/
$vxe-ui-menu-item-hover-color: $vxe-ui-font-primary-color;
$vxe-ui-menu-collapse-wrapper-box-shadow: $vxe-ui-base-popup-box-shadow;
...
/*form-design*/
$vxe-ui-form-design-widget-hover-background-color: $vxe-ui-base-hover-background-color;
