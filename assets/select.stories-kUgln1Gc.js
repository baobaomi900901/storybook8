import"./button-CKICkMOT.js";import{_ as o,a as n}from"./tree_select-TBFvi8sH.js";import"./radio_group-CyS_Gqqs.js";import{r as c}from"./vue.esm-bundler-CPPrNTGp.js";/* empty css               */import"./utils-zdN4c4KV.js";import"./_commonjsHelpers-Cpj98o6Y.js";const K={title:"Data Entry(DE)/KSelect",component:o,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","base"]},color:{control:"color"}},args:{}},e={name:"默认",args:{},render:s=>({components:{KSelect:o,KOption:n},setup(){const r=c("1");return{args:s,options:[{value:"0",label:"全部"},{value:"1",label:"菜单"},{value:"2",label:"组件"},{value:"3",label:"流程"},{value:"4",label:"执行历史"}],selectValue:r}},template:`
