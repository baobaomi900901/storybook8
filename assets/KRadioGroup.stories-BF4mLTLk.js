import{a as i,_ as d}from"./radio_group-D_jRz0nj.js";import{r as u}from"./vue.esm-bundler-CjPtUVfS.js";import"./index-JNNWE467.js";const G={title:"Data Entry(DE)/KRadioGroup",component:i,tags:["autodocs"],argTypes:{size:{control:"select",options:["base","sm"]},direction:{control:"select",options:["row","column"]},button:{control:"boolean"}},args:{size:"base",direction:"row",button:!1}},r={args:{},render:o=>({components:{KRadioGroup:i,KRadio:d},setup(){const a=u(0);return{args:o,radio:a}},template:`
