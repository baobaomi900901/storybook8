...
const doc2 = ATExample(btnSize, '尺寸: sm', btnSizeDoc);
export const example2: Story = {
  name: 'size: sm',
  ...doc2,
};

const doc3 = ATExample(btnDisabled, '禁用按钮', btnDisabledDoc);
export const example3: Story = {
  name: 'disabled:禁用按钮',
  ...doc3,
};

const doc4 = ATExample(btnLoading, '加载中', btnLoadingDoc);
export const example4: Story = {
  name: 'loading:加载中',
  ...doc4,
};

const doc5 = ATExample(btnIconSlot, '按钮左右侧图标', btnIconSlotDoc);
export const example5: Story = {
  name: 'icon:按钮左右侧图标',
  ...doc5,
};

const doc6 = ATExample(btnColor, 'el-type', btnColorDoc);
export const example6: Story = {
  name: 'color:支持 el-type 类型 与 自定义颜色',
  ...doc6,
};

const doc7 = ATExample(btnIcon, '自定义图标', btnIconDoc);
export const example7: Story = {
  name: 'icon:插入图标',
  ...doc7,
};

const doc9 = ATExample(btnGroup, '按钮组', btnGroupDoc);
