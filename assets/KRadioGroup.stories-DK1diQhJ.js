...
<\/script>
<style>
</style>`,j={title:"Data Entry(DE)/KRadioGroup",component:p,tags:["autodocs"],argTypes:{size:{control:"select",options:["base","sm"]},direction:{control:"select",options:["row","column"]}},args:{size:"base",direction:"row"}},u={args:{},render:s=>({components:{KRadioGroup:p,KRadio:n},setup(){const d=m(0);return{args:s,radio:d}},template:`
      <k-radio-group v-model="radio" :direction=args.direction :size=args.size  :button=args.button>
        <KRadio :value="0" >直角</KRadio>
        <KRadio :value="1" >钝角</KRadio>
        <KRadio :value="2" >锐角</KRadio>
        <KRadio :value="0" disabled >直角</KRadio>
      </k-radio-group>`})},l={name:"button : 控制不同样式",render:s=>({components:{btn:B},setup(){return{args:s}},template:'<btn v-bind="args" />'}),parameters:{docs:{source:{code:U}}}},c={name:"size : 不同尺寸",render:s=>({components:{size:D},setup(){return{args:s}},template:'<size v-bind="args" />'}),parameters:{docs:{source:{code:I}}}};var _,b,f;u.parameters={...u.parameters,docs:{...(_=u.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {},
  render: (args: any) => {
    return {
      components: {
...
}`,...(f=(b=u.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};var g,z,V;l.parameters={...l.parameters,docs:{...(g=l.parameters)==null?void 0:g.docs,source:{originalSource:`{
  name: 'button : 控制不同样式',
  render: (args: any) => ({
    components: {
      btn
...
}`,...(k=(G=c.parameters)==null?void 0:G.docs)==null?void 0:k.source}}};const q=["def","sizeSB2","sizeSB"];export{q as __namedExportsOrder,u as def,j as default,c as sizeSB,l as sizeSB2};
