...
<\/script>
<style scoped>
</style>`,H={class:"grid grid-cols-2 gap-4"},J=p("div",null,"密码输入框:",-1),M=p("div",null,"显示密码按钮:",-1),j={__name:"showPassword",setup(t){const e=n(""),a=n("");return(r,o)=>{const s=c("k-input");return i(),u("div",H,[J,M,l(s,{modelValue:e.value,"onUpdate:modelValue":o[0]||(o[0]=d=>e.value=d),type:"password"},null,8,["modelValue"]),l(s,{modelValue:a.value,"onUpdate:modelValue":o[1]||(o[1]=d=>a.value=d),showPassword:""},null,8,["modelValue"])])}}};j.__docgenInfo={exportName:"default",displayName:"showPassword",description:"",tags:{},sourceFiles:["/home/runner/work/storybook8/storybook8/src/DocS/input/showPassword.vue"]};const Q=`<template>
...
<\/script>
<style scoped>
</style>`,X={class:"grid grid-cols-2 gap-4"},Y=p("div",null,"普通文本域:",-1),Z=p("div",null,"自适应高度:",-1),T={__name:"textarea",setup(t){const e=n(""),a=n("");return(r,o)=>{const s=c("k-input");return i(),u("div",X,[Y,Z,l(s,{modelValue:e.value,"onUpdate:modelValue":o[0]||(o[0]=d=>e.value=d),type:"textarea",placeholder:"Enter text"},null,8,["modelValue"]),l(s,{modelValue:a.value,"onUpdate:modelValue":o[1]||(o[1]=d=>a.value=d),type:"textarea",placeholder:"Enter text",autosize:{minRows:2,maxRows:4}},null,8,["modelValue"])])}}};T.__docgenInfo={exportName:"default",displayName:"textarea",description:"",tags:{},sourceFiles:["/home/runner/work/storybook8/storybook8/src/DocS/input/textarea.vue"]};const ee=`<template>
  <div class="grid grid-cols-2 gap-4">
    <div>普通文本域:</div>
    <div>自适应高度:</div>
...
<style scoped>
      ...
      `}}},v={name:"disabled : 禁止输入",render:t=>({components:{disabled:z},setup(){return{args:t}},template:'<disabled v-bind="args" />'}),parameters:{docs:{source:{code:q}}}},x={name:"clearable : 一键清空",render:t=>({components:{clearable:K},setup(){return{args:t}},template:'<clearable v-bind="args" />'}),parameters:{docs:{source:{code:G}}}},_={name:"showPassword : 显示密码",render:t=>({components:{showPassword:j},setup(){return{args:t}},template:'<showPassword v-bind="args" />'}),parameters:{docs:{source:{code:Q}}}},g={name:"textarea : 文本域",render:t=>({components:{ktextarea:T},setup(){return{args:t}},template:'<ktextarea v-bind="args" />'}),parameters:{docs:{source:{code:ee}}}},b={name:"maxInput : 文本域",render:t=>({components:{maxInput:C},setup(){return{args:t}},template:'<maxInput v-bind="args" />'}),parameters:{docs:{source:{code:re}}}};var w,k,y;m.parameters={...m.parameters,docs:{...(w=m.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: '默认用法',
  args: {
    type: 'text',
    clearable: false
