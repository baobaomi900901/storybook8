import"./button-vfpO414I.js";import{b as B}from"./tree_select-bkgaSM_d.js";import"./radio_group-Ci8auAZ1.js";import{d as M,r as s,b as h,j as p,c as r,f as i,m as $,F as k,o as C,x as g,p as j,t as D,y as w}from"./vue.esm-bundler-DB-BIHtd.js";import{A as E}from"./index-wXGUTIPA.js";import"./index-nFJc4fXK.js";import"./_commonjsHelpers-Cpj98o6Y.js";const N=M({__name:"Indeterminate",setup(b){const o=s(!1),c=s(!0),l=s(["Shanghai","Beijing"]),n=["Shanghai","Beijing","Guangzhou","Shenzhen"],x=e=>{l.value=e?n:[],c.value=!1},v=e=>{const a=e.length;o.value=a===n.length,c.value=a>0&&a<n.length};return(e,a)=>{const f=h("KCheckbox"),F=h("KCheckboxGroup");return C(),p(k,null,[r(f,$({modelValue:o.value,"onUpdate:modelValue":a[0]||(a[0]=t=>o.value=t),indeterminate:c.value,onChange:x},e.$attrs),{default:i(()=>[g(" Check all ")]),_:1},16,["modelValue","indeterminate"]),r(F,{modelValue:l.value,"onUpdate:modelValue":a[1]||(a[1]=t=>l.value=t),onChange:v},{default:i(()=>[(C(),p(k,null,j(n,t=>r(f,{key:t,label:t,value:t},{default:i(()=>[g(D(t),1)]),_:2},1032,["label","value"])),64))]),_:1},8,["modelValue"])],64)}}});N.__docgenInfo={exportName:"default",displayName:"Indeterminate",description:"",tags:{},sourceFiles:["/home/runner/work/storybook8/storybook8/src/doc/checkbox/Indeterminate.vue"]};const U=`<template>
  <KCheckbox
    v-model="checkAll"
