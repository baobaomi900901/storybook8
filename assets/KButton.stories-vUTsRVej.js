import{_ as o}from"./button-e4jVQeVe.js";import"./vue.esm-bundler-BJoIvmbj.js";import{a as t,i}from"./arrow-bottom-Bk-6L4KA.js";import"./index-nFJc4fXK.js";const N={title:"Base(B)/KButton",component:o,tags:["autodocs"],argTypes:{value:"text",size:{control:"select",options:["base","sm"]},main:"boolean",secondary:"boolean",text:"boolean",icon:"boolean",disabled:"boolean",loading:"boolean",iconLeft:"",iconRight:"",type:{control:"select",options:["normal","main","secondary","text","icon"]},color:{control:"color"}},args:{}},e={name:"默认",args:{value:"Button"}},r={name:"各类型按钮",args:{value:"新增",main:!0},render:n=>({components:{KButton:o,IconAdd:t},setup(){return{args:n,IconAdd:t}},template:`
