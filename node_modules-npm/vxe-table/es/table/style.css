...
.vxe-cell > .vxe-cell--tree-node .vxe-input,
.vxe-cell > .vxe-cell--tree-node .vxe-textarea,
.vxe-cell > .vxe-cell--tree-node .vxe-select,
...
.vxe-body--column.col--vertical-top > .vxe-cell {
  height: 100%;
}
...
/*列宽*/
.vxe-table.column--calc .vxe-header--column .vxe-cell,
.vxe-table.column--calc .vxe-body--column .vxe-cell,
.vxe-table.column--calc .vxe-footer--column .vxe-cell {
  word-break: break-all;
  white-space: nowrap;
}
...
.vxe-table--render-default.cell--area .vxe-table--body-wrapper,
.vxe-table--render-default.cell--area .vxe-body--column {
  -webkit-user-select: none;
     -moz-user-select: none;
          user-select: none;
}
...
.vxe-table--render-default .vxe-table--scroll-x-virtual,
.vxe-table--render-default .vxe-table--scroll-y-virtual {
  position: absolute;
  z-index: 7;
  overflow: hidden;
}
.vxe-table--render-default .vxe-table--scroll-x-handle,
.vxe-table--render-default .vxe-table--scroll-y-handle {
  position: absolute;
}
.vxe-table--render-default .vxe-table--scroll-x-handle div,
...
.vxe-table--render-default .vxe-table--scroll-x-space {
  height: 1px;
}
.vxe-table--render-default .vxe-table--scroll-y-space {
  width: 1px;
}
