import"./button-Bdp72iJS.js";import{b as B}from"./tree_select-KLl3cXDb.js";import"./radio_group-IruEeixh.js";import{f as j,r as s,j as h,t as p,e as r,l as i,m as w,F as k,o as C,E as g,z as N,v as E,G as T}from"./vue.esm-bundler-N-wW40t0.js";import{A as D}from"./index-wXGUTIPA.js";import"./utils-D6daWLFa.js";import"./_commonjsHelpers-Cpj98o6Y.js";const F=j({__name:"Indeterminate",setup(b){const o=s(!1),c=s(!0),l=s(["Shanghai","Beijing"]),n=["Shanghai","Beijing","Guangzhou","Shenzhen"],x=e=>{l.value=e?n:[],c.value=!1},v=e=>{const a=e.length;o.value=a===n.length,c.value=a>0&&a<n.length};return(e,a)=>{const f=h("KCheckbox"),$=h("KCheckboxGroup");return C(),p(k,null,[r(f,w({modelValue:o.value,"onUpdate:modelValue":a[0]||(a[0]=t=>o.value=t),indeterminate:c.value,onChange:x},e.$attrs),{default:i(()=>[g(" Check all ")]),_:1},16,["modelValue","indeterminate"]),r($,{modelValue:l.value,"onUpdate:modelValue":a[1]||(a[1]=t=>l.value=t),onChange:v},{default:i(()=>[(C(),p(k,null,N(n,t=>r(f,{key:t,label:t,value:t},{default:i(()=>[g(E(t),1)]),_:2},1032,["label","value"])),64))]),_:1},8,["modelValue"])],64)}}});F.__docgenInfo={exportName:"default",displayName:"Indeterminate",description:"",tags:{},sourceFiles:["/home/runner/work/storybook8/storybook8/src/doc/checkbox/Indeterminate.vue"]};const U=`<template>
  <KCheckbox
    v-model="checkAll"
