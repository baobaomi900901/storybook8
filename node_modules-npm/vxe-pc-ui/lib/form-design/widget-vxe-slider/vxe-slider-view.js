...
exports.WidgetVxeSliderViewComponent = void 0;
var _vue = require("vue");
var _use = require("../src/use");
var _formItem = _interopRequireDefault(require("../../form/src/form-item"));
var _slider = _interopRequireDefault(require("../../slider/src/slider"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
const WidgetVxeSliderViewComponent = exports.WidgetVxeSliderViewComponent = (0, _vue.defineComponent)({
  props: {
    renderOpts: {
      type: Object,
      default: () => ({})
  ...
  setup(props) {
    ...
    return () => {
      ...
      return (0, _vue.h)(_formItem.default, {
        ...
        default() {
          return (0, _vue.h)(_slider.default, {
