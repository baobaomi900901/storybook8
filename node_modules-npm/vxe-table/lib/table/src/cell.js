...
function renderCellBaseVNs(params, content) {
  ...
  const vns = _xeUtils.default.isArray(content) ? content : [content];
  const {
    computeRowOpts,
    computeDragOpts
...
function getFooterContent(params) {
  ...
  if (renderOpts) {
    ...
    if (compConf) {
      ...
      if (rtFooter) {
        return (0, _vn.getSlotVNs)(rtFooter(renderOpts, params));
      }
    }
  }
  let itemValue = '';
...
const Cell = exports.Cell = {
  ...
  renderTreeIcon(params, cellVNodes) {
    ...
    }, [showIcon && (lazy ? isLazyLoaded ? hasChild : hasLazyChilds : hasChild) ? [(0, _vue.h)('div', Object.assign({
