import{a as n,b as c}from"./tree_transfer-4-bA9atr.js";import{r as m}from"./vue.esm-bundler-Cftbljzo.js";import"./_commonjsHelpers-Cpj98o6Y.js";const v={title:"Data Entry(DE)/KRadioGroup",component:n,tags:["autodocs"],argTypes:{direction:{table:{type:{summary:"string"},defaultValue:{summary:"row"}},control:"select",options:["row","column"],description:"布局方向"},change:{description:"? 事件说明"},"update:modelValue":{description:" ? 事件说明"}},args:{}},r={args:{direction:"row"},render:e=>({components:{KRadioGroup:n,KRadio:c},setup(){const a=m(0);return{args:e,modelValue:a}},template:`
