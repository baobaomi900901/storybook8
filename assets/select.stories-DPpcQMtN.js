import"./button-BmBQGL3n.js";import{_ as o,a as n}from"./tree_select-B-cMQ_oz.js";import"./radio_group-CTOfIhN6.js";import{r as c}from"./vue.esm-bundler-zDk3ptr0.js";/* empty css               */import"./index-nFJc4fXK.js";import"./_commonjsHelpers-Cpj98o6Y.js";const K={title:"Data Entry(DE)/KSelect",component:o,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","base"]},color:{control:"color"}},args:{}},e={name:"默认",args:{},render:s=>({components:{KSelect:o,KOption:n},setup(){const r=c("1");return{args:s,options:[{value:"0",label:"全部"},{value:"1",label:"菜单"},{value:"2",label:"组件"},{value:"3",label:"流程"},{value:"4",label:"执行历史"}],selectValue:r}},template:`
