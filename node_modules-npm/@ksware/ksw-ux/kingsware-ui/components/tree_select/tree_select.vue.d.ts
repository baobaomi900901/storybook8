...
declare function __VLS_template(): {
    ...
    refs: {
        KTreeSelectRef: ({
            ...
            } & import('vue').VNodeProps & import('vue').AllowedComponentProps & import('vue').ComponentCustomProps & Readonly<any>, never>;
            $attrs: {
                [x: string]: unknown;
            };
            $refs: {
...
declare const __VLS_component: import('vue').DefineComponent<TreeSelectProps, any, {}, {}, {}, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, {
    input: (...args: any[]) => void;
    blur: (...args: any[]) => void;
