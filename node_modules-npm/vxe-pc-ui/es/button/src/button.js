        ...
        const renderVN = () => {
            ...
            if (downsSlot) {
                ...
                return h('div', {
                    ...
                    routerLink
                        ? h(resolveComponent('router-link'), Object.assign({ ref: refButton, class: ['vxe-button', 'vxe-button--link', `type--${btnMode}`, align ? `align--${align}` : '', className ? (XEUtils.isFunction(className) ? className({ $button: $xeButton }) : className) : '', {
                                    [`size--${vSize}`]: vSize,
                        ...
                        : h('button', Object.assign({ ref: refButton, class: ['vxe-button', `type--${btnMode}`, align ? `align--${align}` : '', className ? (XEUtils.isFunction(className) ? className({ $button: $xeButton }) : className) : '', {
                                    [`size--${vSize}`]: vSize,
                                    [`theme--${btnStatus}`]: btnStatus,
                                    'is--round': btnRound,
                                    'is--circle': btnCircle,
