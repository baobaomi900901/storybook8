...
var _default = exports.default = (0, _vue.defineComponent)({
  ...
  setup(props, context) {
    ...
    const computeScrollLoad = () => {
      return (0, _vue.nextTick)().then(() => {
        ...
        if (scrollXLoad) {
          ...
          const offsetXSize = Math.max(bufferSize, sXOpts.oSize ? _xeUtils.default.toNumber(sXOpts.oSize) : _dom.browse.edge ? 5 : 0);
        ...
        if (scrollYLoad) {
          // 动态高缓冲量
          const bufferSize = showOverflow ? 0 : 2;
          const offsetYSize = Math.max(bufferSize, sYOpts.oSize ? _xeUtils.default.toNumber(sYOpts.oSize) : _dom.browse.edge ? 10 : 0);
    ...
    const debounceScrollYData = _xeUtils.default.debounce(function () {
      loadScrollYData();
    }, 20, {
      leading: false,
      trailing: true
    ...
    tableMethods = {
      ...
      clearScroll() {
        ...
        if (xHandleEl) {
          ...
          (0, _dom.setScrollLeft)(tableBodyElem, 0);
          (0, _dom.setScrollLeft)(tableHeaderElem, 0);
          (0, _dom.setScrollLeft)(tableFooterElem, 0);
        }
        const yHandleEl = refScrollYHandleElem.value;
        if (yHandleEl) {
          (0, _dom.setScrollTop)(yHandleEl, 0);
        } else {
          (0, _dom.setScrollTop)(tableBodyElem, 0);
          (0, _dom.setScrollTop)(leftBodyElem, 0);
          (0, _dom.setScrollTop)(rightBodyElem, 0);
        }
        scrollXStore.startIndex = 0;
    ...
    const renderVN = () => {
      ...
      }, [leftList && leftList.length && overflowX ? renderFixed('left') : (0, _vue.createCommentVNode)(), rightList && rightList.length && overflowX ? renderFixed('right') : (0, _vue.createCommentVNode)()])]), virtualScrollBars.x ? (0, _vue.h)('div', {
        key: 'vx',
      ...
      })])]) : (0, _vue.createCommentVNode)(), virtualScrollBars.y ? (0, _vue.h)('div', {
        key: 'vy',
